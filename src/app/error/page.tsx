...
export const metadata: Metadata = {
  title: "Error Page | The Origin",
  description: "This is Error Page for The Origin. Learn a new language while you watch. Enjoy films, pick up conversation skills, and explore new cultures.",
